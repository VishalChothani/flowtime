...
export function About() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-indigo-950">
      <article className="mx-auto max-w-2xl px-4 text-center">
        ...
        <section aria-label="Technology stack">
          ...
          <ul className="mb-8 grid grid-cols-2 gap-4 text-left sm:grid-cols-3">
            {techStack.map((tech) => (
              <li
                key={tech.name}
